...
if(isset($_GET['district_id'])){
  ...
  <?php
    $query=mysqli_query($con,"SELECT * FROM safedocx_districts,safedocx_states WHERE state_id=district_state_id AND district_id=$district_id");
    while($row=mysqli_fetch_array($query)){
      ...
      <form method="post" id="district_edit_form" class="district_edit_form" onsubmit="return false">
        ...
        <hr>
        <input type="hidden" id="district_id" class="district_id" value="<?php echo $district_id;?>">
